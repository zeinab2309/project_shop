...
def export_to_excel(modeladmin, request,queryset):
    ...
    ws.title ="Orders"
    #-----------------------
    columns=['ID','First Name','Last Name','Phone','Address','Postal Code','Province','City',
            'Paid','Created']
    ws.append(columns)
    #-----------------------
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['id', 'buyer', 'first_name','last_name','phone','address','postal_code','province','city','paid','created','updated']
